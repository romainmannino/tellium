...
export class TelliumRenderer {
  ...
  private drawGlobeBackdrop(ctx: CanvasRenderingContext2D) {
    ...
    /*
     * Halo bleu extérieur : légèrement diffus,
     * clairement séparé du contour physique du globe.
     */
    ctx.save();
    ctx.shadowColor = "rgba(65,145,245,0.42)";
    ctx.shadowBlur = 12;
    ctx.strokeStyle = "rgba(66,143,238,0.22)";
    ctx.lineWidth = 2.1;
    ctx.beginPath();
    ...
    /*
     * Limbe blanc : très fin mais beaucoup plus contrasté,
     * comme l’atmosphère réelle observée depuis l’espace.
     */
    ctx.strokeStyle = "rgba(235,247,255,0.76)";
    ctx.lineWidth = 0.72;
    ctx.beginPath();
