...
export class TelliumRenderer {
  ...
  private drawGlobeBackdrop(ctx: CanvasRenderingContext2D) {
    ...
    atm.addColorStop(0.43, "rgba(62,132,235,0.2)");
    atm.addColorStop(0.68, "rgba(255,185,95,0.08)");
    ...
    disc.addColorStop(0, "#091225");
    disc.addColorStop(0.68, "#050b17");
    disc.addColorStop(1, "#02050b");
    ctx.fillStyle = disc;
    ctx.beginPath();
